 ...
 *       &lt;sequence>
 *         &lt;element name="characterInfo" type="{http://www.panthers.com/panthers-ws}characterInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllCharactersResponse {
    ...
    protected List<CharacterInfo> characterInfo;
    ...
    public List<CharacterInfo> getCharacterInfo() {
        if (characterInfo == null) {
            characterInfo = new ArrayList<CharacterInfo>();
        }
